...
public class TaipeiOkProvider extends ContentProvider {
	...
	static final String PROVIDER_NAME = "tcnr18.com.project.TaipeiOkProvider";
	...
	private static final String URL_RAW_QUERY = "content://" + PROVIDER_NAME
			+ "/" + SUB2;
	...
	static private final String DATABASE_NAME = "taipei.db"; // YOUR DESIRED
																// DATABASE
	static private final String TABLE_NAME = "ok"; // YOUR DESIRED TABLE
	static private final int DATABASE_VERSION = 5; // ### need to increase when
													// change

	static private final String COL0 = COLUMN_ID
			+ " INTEGER PRIMARY KEY AUTOINCREMENT";
	static private final String COL1 = COLUMN_NAME + " TEXT NOT NULL ";
	static private final String COL2 = COLUMN_CERTIFICATION_CATEGORY
			+ " TEXT NOT NULL ";
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		case uriCodeRawQuery:
			String sql = "SELECT " + COLUMN_ID + "," + COLUMN_DISTRICT
					+ ", COUNT(" + COLUMN_DISTRICT + ") AS CNT" + " FROM "
